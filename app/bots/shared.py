...
def client_main_keyboard() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="注册账号"), KeyboardButton(text="我的账号")],
            [KeyboardButton(text="在线播放人数"), KeyboardButton(text="联系管理员")],
        ],
...
def admin_main_keyboard() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="生成注册码"), KeyboardButton(text="查询注册码库存")],
            [KeyboardButton(text="删除注册码库存"), KeyboardButton(text="查询有效账号")],
            [KeyboardButton(text="新增注册账号"), KeyboardButton(text="删除用户信息")],
            [KeyboardButton(text="修改用户时间"), KeyboardButton(text="查询用户登录信息")],
            [KeyboardButton(text="同步Emby到本地"), KeyboardButton(text="同步本地到Emby")],
            [KeyboardButton(text="在线播放人数")],
        ],
        resize_keyboard=True,
        is_persistent=True,
    )
